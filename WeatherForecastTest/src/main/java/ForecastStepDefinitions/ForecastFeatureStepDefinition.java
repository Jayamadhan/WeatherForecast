...
public class ForecastFeatureStepDefinition 
{
	...
	public void user_is_on_home_page() throws Throwable 
	{
		...
		FileUtils.copyFile(src, new File(configFileReader.getScreenShotsPath() + "verifyHompge.jpg"));
	}	
	...
	public void verifyCitywithCountryCode() throws IOException
	{
		...
		src = screenshot.getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File(configFileReader.getScreenShotsPath() + "verifyCitypresent.jpg"));
	...
	private void verifyText_fiveDayWeather() throws IOException 
	{
		...
		src = screenshot.getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File(configFileReader.getScreenShotsPath() + "forecastpresent.jpg"));
	...
	private void verifyValues_fiveDayWeather() throws IOException 
	{
		...
		src = screenshot.getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File(configFileReader.getScreenShotsPath() + "5dayforecast.jpg"));
	...
	public void verify_Hourly(String day) throws IOException
	{
		...
		src = screenshot.getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File(configFileReader.getScreenShotsPath() + "hourlytext.jpg"));
	...
	public void verify_DailyForecast(String day) throws IOException
	{
		...
		src = screenshot.getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File(configFileReader.getScreenShotsPath() + "dailyvalues.jpg"));
